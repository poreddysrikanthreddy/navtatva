  ...
  return (
    <section className="mt-4 mt-md-5 pb-5">
      <div className="wrapper">
        <div className="row">
          <SectionHeader title={"Kurtis For Every Occassion"} />
              ...
              <Slider {...exploreMoreSetting}>
                {props.data.map((info: any, index: number) => {
                  return (
                    <div
                      key={index}
                      className="thumb position-relative text-center"
                    >
                      <div className="bg1">
                        <a
                          onClick={() =>
                            router.replace(Permalink.ofProduct(info))
                          }
                        >
                          <Image
                        ...
                        <div className="hoverBlock">
                          ...
                          <div className="speaker">
                            ...
                            {wishItems?.includes(info.id) ? (
                              <div className="product-block-1 mb-5">
                                <button
                                  type="button"
                                  className="btn-heart mb-5 "
                                  onClick={() => {
                                    props.onDeletwishlistItem(info?.id);
                                  }}
                                >
...
export default KurtisForOccassion;
